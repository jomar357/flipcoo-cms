			...
			<div style={{ background: '#fff' }}>
				...
				<div className="container text-center community-section dropshipping-tips" id="community-section-1">
					<div className="row">
					    ...
					    <div className="col-lg-4 col-md-6">
					    	<div className="community-news text-left">
					    		<img src={WhatIsDropshippingImg} alt="what you need to know about dropshipping" />
					    		<div className="community-news-content">
					    			<h3>What You Need to Know about Dropshipping</h3>
					    			<p>Dropshipping is a retail method in which you do not keep products in stock. It is a term used in supply chain management in which retailers do not maintain product inventory.</p>
					    			<a className="btn-primary btn-read-more" href="#">
					    				Read More <i className="fa fa-caret-right"></i>
					    			</a>
					    		</div>	
					    ...
					    <div className="col-lg-4 col-md-6">
					    	<div className="community-news text-left">
					    		<img src={ValueLogicsImg} alt="7 important value logics for product selection" />
					    		<div className="community-news-content">
					    			<h3>What You Need to Know about Dropshipping</h3>
					    			<p>What are specific methods and thinking logic of selecting products? After the study of the hottest products last year, 7 value logics could be concluded for your future reference.</p>
					    			<a className="btn-primary btn-read-more" href="#">
					    				Read More <i className="fa fa-caret-right"></i>
					    			</a>
					    		</div>	
