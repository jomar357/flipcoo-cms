...
const IconSliderMobile = () => {
  return (
    <OwlCarousel className="owl-theme" loop margin={10} dots={false} navSpeed={1000} autoplay={true} items={1} nav navText={'',''} >
        <div>
...
export default IconSliderMobile